...
const ProfileSettings: React.FC<Props> = (props: Props) => {
    ...
    const { profileDetails, coverImageLoading, coverImageURI, loading, profileImageURI } = state;
    ...
    const getProfileDetails = () => {
        getProfiles({
            ...
            setState({ coverImageURI: profile.data.profiles.items[0].coverPicture });
        });
    };
                    ...
                    <form
                        ...
                        <div className="grid gap-2">
                            ...
                            <input
                                ...
                                placeholder="Enter username"
                                className="primary-input w-full"
                                defaultValue={profileDetails[0].attributes.find(
                        ...
                        <div className="grid gap-2">
                            ...
                            <input
                                ...
                                placeholder="Enter username"
                                className="primary-input w-full"
                                defaultValue={profileDetails[0].location}
                                {...register('location')}
                            />
                        </div>
                        ...
                        <div className="grid gap-2 relative">
                            ...
                            <input
                                ...
                                className="pl-10 primary-input w-full"
                                defaultValue={profileDetails[0].twitter}
                                {...register('twitter')}
                            />
                        </div>
