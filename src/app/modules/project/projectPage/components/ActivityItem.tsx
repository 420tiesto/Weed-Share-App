...
import ThreeDotsCircleIcon from '../../../../icons/ThreeDotsCircleIcon'
    ...
    <div className='elevated-element divide-dark-gray divide-y-2 gap-4'>
      <div className='p-4 space-y-4'>
        <div className='flex gap-4'>
          <img src="https://images.unsplash.com/photo-1490604001847-b712b0c2f967?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1853&q=80" 
          alt="pfp" className='rounded-full h-12 w-12' />
