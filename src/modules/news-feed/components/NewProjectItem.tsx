import { ChatIcon, DotsVerticalIcon, UserGroupIcon } from '@heroicons/react/solid';
...
const NewProjectItem = ({id,previewImgSrc,creator="",pfpSrc,projectTitle="Loading...",projectDescription="...",joinedCount=0,commentsCount=0}: Props) => {
    return (
            ...
            <Card variant="elevated" rounded="2xl">
                <CardBody padding={6} className="flex items-center gap-8">
                    <div className="h-[200px] elevated-element w-[240px] rounded-[30px] bg-gray overflow-hidden border-2 ">
                        <img src={previewImgSrc} alt="" className="h-full w-full object-center object-cover" />
                    </div>
